...
class Combiner:
    ...
    def combine(self, index2):
        ...
        if A.any() == None:  # RANSAC sometimes fails in estimateRigidTransform(). If so, try full homography. OpenCV RANSAC implementation for homography is more robust.
        ...
        for i in range(0, 4):
            ...
            if A.any() != None:  # check if we're working with affine transform or perspective transform
