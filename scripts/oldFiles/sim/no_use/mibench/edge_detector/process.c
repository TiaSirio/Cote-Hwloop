  ...
  */
  ...
  int main(int argc, char *argv[])
  {
    ...
    char datasetAddress[100] = "datasets/pgm/";
    ...
    if (argc > 1) {
      ...
      do { 
          ...
          if (*argv[count] == '-') {
            ...
            case 'i' :
                    count++;
                      strcat(datasetAddress, argv[count]);
                      strcpy(file_in, datasetAddress);
                      set_file_in = TRUE;
                      pgmfile = FALSE;
                      break;
            case 'p' :
            ...
            case 'o' :
                    count++;
                      char resultAddress[100] = "results/edge_detector/";
                      strcat(resultAddress, argv[count]);
                      strcpy(file_out, resultAddress);
                      set_file_out = TRUE;
                      break;
            case 'w' : 
                count++;
