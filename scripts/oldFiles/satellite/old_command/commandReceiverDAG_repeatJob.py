    ...
    while True:
        ...
        if msg == executeCommand:
            ...
            if not programsToExecute:
                ...
                client.loop_stop()
                while taskCount < len(programsToExecute):
                #for program in programsToExecute:
                    ...
                    if ";" in programsToExecute[index]:
                        # Write the regex to split except when double quotes
                        arguments = programsToExecute[index].split(";")
                        ...
                        arguments.append(programsToExecute[index])
                    ...
                    if arguments[0].endswith(".py"):
                        ...
                        arguments.pop(0)
                        execString = "./" + programsToExecute[index]
                        arguments.insert(0, execString)
                    ...
                    if not errorFound:
                        ...
                        outputsOfPrograms[programsToExecute[index]] = resultsOfTaskString
