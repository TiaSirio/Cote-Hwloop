...
cd $HOME/git-repos/cote-hwloop/artifacts/cstp-base/scripts/
./run_cstp_base_sims.sh
#cd $HOME/git-repos/cote-hwloop/artifacts/cstp-mcap/scripts/
#./run_cstp_mcap_sims.sh
#cd $HOME/git-repos/cote-hwloop/artifacts/cstp-mpow/scripts/
#./run_cstp_mpow_sims.sh
#cd $HOME/git-repos/cote-hwloop/artifacts/cstp-mprc/scripts/
