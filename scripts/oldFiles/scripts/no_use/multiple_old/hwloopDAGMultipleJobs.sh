...
./configureCubeSatSimDAGMultipleJobs.sh 1
...
./process_hwloop_logs_dag_multiple.sh "$satellite"

echo "Generating plots..."
./plots_generation_dag_hwloop.sh "$satellite"