...
if len(sys.argv) != 34:
    print("Missing argument: \"s for SingleJob or m for MultipleJobs\", \"Number of Physical satellite\""
          ...
          ", \"Max time to wait\", \"Task to repeat configuration file\", and \"Bash to execute multiple times\"!")
    sys.exit()
...
executeTaskMultipleTimesBash = sys.argv[33]
        ...
        if msg == executeCommand:
            ...
            if not programsToExecute:
                ...
                for program in programsToExecute:
                    ...
                    # Execute the task using a script
                        ...
                        if temp in confMapRepeatProgram:
                            if confMapRepeatProgram[temp] is not None:
                                multipleTimesString = "./" + executeTaskMultipleTimesBash
                                arguments.insert(0, confMapRepeatProgram[temp])
                                arguments.insert(0, multipleTimesString)
                    ...
                    if programRepeated:
                        duration = int((int(endingTimestamp) - int(startingTimestamp))/int(confMapRepeatProgram[temp]))
                    else:
                        ...
                        for line in reversed(lines):
                            ...
                            # elif int(nonFuncValues[0]) < int(1684509376974):
                                ...
                                if programRepeated:
                                    ...
                                    finalNonFuncTimestamp = (str(int(initialNonFuncTimestamp) + int(duration)))
                        ...
                        for line in reversed(lines):
                            ...
                            # elif int(nonFuncPayload[0]) < int(1684516312466):
                                ...
                                if programRepeated:
                                    ...
                                    finalPayloadTimestamp = (str(int(initialPayloadTimestamp) + int(duration)))
