...
./hwloopConfigureEvaluationPhysicalSatellites.sh "configureCubeSatSimEvaluationSystemScalability.sh"
result=$?
...
./"hwloopStopPhysicalSatellitesSystemScalability.sh" "stopSatelliteProgramsEvaluationSystemScalability.sh"
resultStopping=$?
