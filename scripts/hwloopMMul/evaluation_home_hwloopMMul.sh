...
#./"$configureCubeSatSimMultipleSatellites" "$configureCubeSatSim"
#result=$?
...
# Evaluation
echo "$duration" >> "../evaluation/results/scalability/$typeOfEvaluation/$satDirString/simulation_duration.txt"

# Stop running programs on the satellite
#./stopSatellitePrograms.sh
#./"$stopCubeSatSimProgramsMultipleSatellites" "$stopCubeSatSimPrograms"
#resultStopping=$?
